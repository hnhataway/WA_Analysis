...
def getPaginatedLogsInternal(assistant, workspace_id, filter, page_size_limit=DEFAULT_PAGE_SIZE, cursor):
    ...
    if workspace_id is None:
        ...
        output = assistant.list_all_logs(sort='-request_timestamp', filter=filter, page_limit=page_size_limit, cursor=curs)
    else:
        output = assistant.list_logs(workspace_id=workspace_id, sort='-request_timestamp', filter=filter, page_limit=page_size_limit, cursor=curs)
